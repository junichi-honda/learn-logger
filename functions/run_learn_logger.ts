    ...
    elements: [
      {
        ...
        text: { type: "plain_text", text: "\u2190 \u30DB\u30FC\u30E0\u306B\u623B\u308B" },
      },
    ],
  };
}
    ...
    blocks: [
      {
        ...
        element: {
          ...
          options: [
            {
              text: { type: "plain_text", text: "\uD83D\uDCC5 \u5B66\u671F\u3092\u4F5C\u6210\u3059\u308B" },
              value: MenuAction.CreateSemester,
            },
            {
              text: { type: "plain_text", text: "\uD83D\uDCDA \u79D1\u76EE\u3092\u8FFD\u52A0\u3059\u308B" },
              value: MenuAction.AddSubject,
            },
            {
              text: { type: "plain_text", text: "\uD83D\uDCCB \u79D1\u76EE\u3092\u7BA1\u7406\u3059\u308B" },
              value: MenuAction.ManageSubject,
            },
            {
              text: { type: "plain_text", text: "\u270F\uFE0F \u9032\u6357\u3092\u8A18\u9332\u3059\u308B" },
              value: MenuAction.LogProgress,
            },
            {
              text: { type: "plain_text", text: "\uD83D\uDCCA \u9032\u6357\u3092\u78BA\u8A8D\u3059\u308B" },
              value: MenuAction.ViewProgress,
            },
            {
              text: { type: "plain_text", text: "\uD83C\uDF93 \u5B66\u671F\u3092\u7D42\u4E86\u3059\u308B" },
...
function buildCreateSemesterView(channel: string) {
  return {
    ...
    notify_on_close: true,
    private_metadata: JSON.stringify({ channel }),
    title: { type: "plain_text" as const, text: "\u5B66\u671F\u3092\u767B\u9332\u3059\u308B" },
    ...
    blocks: [
      ...
      },
      {
        ...
        element: {
          ...
          options: [
            { text: { type: "plain_text", text: "\u6625\u5B66\u671F" }, value: "\u6625" },
            { text: { type: "plain_text", text: "\u79CB\u5B66\u671F" }, value: "\u79CB" },
          ],
        },
      },
      {
...
function buildLogProgressView(
  ...
  return {
    ...
    title: { type: "plain_text" as const, text: "\u9032\u6357\u3092\u8A18\u9332\u3059\u308B" },
...
function buildViewProgressView(
  ...
  return {
    ...
    notify_on_close: true,
    private_metadata: JSON.stringify({ channel }),
    title: { type: "plain_text" as const, text: "\u9032\u6357\u3092\u78BA\u8A8D\u3059\u308B" },
...
function buildCloseSemesterView(
  ...
  return {
    ...
    title: { type: "plain_text" as const, text: "\u5B66\u671F\u3092\u7D42\u4E86\u3059\u308B" },
    ...
    blocks: [
      homeButtonBlock(),
      {
        ...
        text: {
          type: "mrkdwn",
          text: `*${semester.year}\u5E74 ${semester.season}\u5B66\u671F* \u3092\u7D42\u4E86\u3057\u307E\u3059\u304B\uFF1F\n\n\u26A0\uFE0F \u3053\u306E\u64CD\u4F5C\u306F\u53D6\u308A\u6D88\u305B\u307E\u305B\u3093\u3002`,
        },
      },
    ],
  };
...
async function querySubjects(client: any, semesterId: string): Promise<SubjectItem[]> {
...
// deno-lint-ignore no-explicit-any
async function fetchActiveSemester(client: any, userId: string) {
  const res = await client.apps.datastore.query({
...
// deno-lint-ignore no-explicit-any
async function completeQuietly(client: any, executionId: string) {
  ...
  async ({ view, client, body }) => {
    ...
    switch (selected) {
      ...
      case MenuAction.LogProgress: {
        ...
        return {
          response_action: "update" as const,
          view: buildLogProgressView(channel, semester, subjectsRes.items),
        };
      }
  ...
  async ({ view, client, body }) => {
    ...
    if (subjectName.length === 0) {
      return {
        response_action: "errors" as const,
        errors: {
          [`subject_name_block_${seq}`]: "\u79D1\u76EE\u540D\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
        },
      };
    }
    ...
    if (!putRes.ok) {
      return {
        response_action: "errors" as const,
        errors: {
          [`subject_name_block_${seq}`]: `\u4FDD\u5B58\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${putRes.error}`,
        },
      };
    }
  ...
  async ({ view, client, body }) => {
    ...
    if (metadata.mode === "list") {
      ...
      if (action === "delete") {
        ...
        if (subjects.length === 0) {
          const msg = `\uD83D\uDDD1\uFE0F \u79D1\u76EE\u300C${selectedSubject.subject_name}\u300D\u3092\u524A\u9664\u3057\u307E\u3057\u305F\u3002\n\u767B\u9332\u79D1\u76EE\u304C\u306A\u304F\u306A\u308A\u307E\u3057\u305F\u3002`;
...
.addViewClosedHandler(
  ...
  async ({ view, body, client }) => {
    const metadata: ManageSubjectMeta = JSON.parse(view.private_metadata!);
    const msg = `\uD83D\uDCCB ${metadata.semester_year}\u5E74 ${metadata.semester_season}\u5B66\u671F\u306E\u79D1\u76EE\u7BA1\u7406\u3092\u7D42\u4E86\u3057\u307E\u3057\u305F\u3002`;
    await client.chat.postMessage({ channel: body.user.id, text: msg });
    await completeQuietly(client, body.function_data.execution_id);
  },
)
